import pygame
import numpy as np
from ClasesExtra import Celula, Tablero
import os
...
def pantalla_inicial_input() -> int:
    ...
    pygame.display.set_caption("Juego de la Vida Extra - Ingresa Tamaño")
...
pygame.display.set_caption("El Juego de la Vida Extra")
...
while ejecutando:
    ...
    pygame.display.set_caption(
        f"El Juego de la Vida Extra | Gen: {tablero.generacion} | Pob: {tablero.poblacion()} | {'PAUSADO' if pausado else 'Corriendo...'}")
